...
public class ThirdDayClear : MonoBehaviour
{
    ...
    IEnumerator CheckNightRoutine()
    {
        while (true)
        {
            ...
            if (GameManager.Instance.IsNight && !hasNightTriggered && GameManager.Instance.CurrentWave > 2)
            {
...
[System.Serializable]
public class TextDataThirdDayClear
{
